      ...
      <div className="wishes">
        <div className='wishHeader'>Look at everyone's wishes!</div>
          <div className="scrollableArea">
            {wishes.map((wish) => { 
              return (
                <Link className="wishWrapper" onClick={(event)=>{toggleViewMode(event, wish)}} key={wish.wishID}>
                  ...
                  {(wish.email===email)? (<div className="wishWrapperRight">
                    ...
                    <div className="editButtonWrapper">
                      <img src={Edit}  className="editButton" onClick={(event)=>{toggleEditMode(event, wish)}}/>
                    </div>
